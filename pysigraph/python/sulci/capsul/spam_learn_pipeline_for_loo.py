...
class SpamLearnPipelineForLOO(Pipeline):
    ...
    def pipeline_definition(self):
        ...
        self.nodes["local_error"].process.graph_suffix = u'_local'
        ...
        self.export_parameter("learn_local_registraton", "translation_file")
        ...
        self.export_parameter("global_error", "output_test_directory", "output_test_global_directory")
        self.add_link("test_labeling_global.output_test_directory->output_test_global_directory")
        ...
        # pipeline steps
        self.add_pipeline_step("learning", ['label_priors', 'learn_talairach', 'learn_global_registration', 'learn_local_registraton', u'learn_transformation_priors'])
